...
given in 'game.level_05_challenges'. You can directly use them, and do them in the
next level which is more challenging.
...
Notice that in that lemma we use "intersection" of two filters, which is not the usual
...
This is defined in 'game.level_05_challenges' and you can verify it forms a filter there.
-/
...
Notice that some of the lemmas above are in 'game.level_05_challenges',
