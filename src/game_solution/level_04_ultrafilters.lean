...
given in 'game.level_06_challenges'. You can directly use them, and do them in the
...
This is defined in 'game.level_06_challenges' and you can verify it forms a filter there.
-/
